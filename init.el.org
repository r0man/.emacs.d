...
** Clojure Treesitter Mode

Major mode that provides font-lock (syntax highlighting), indentation,
and navigation support for the Clojure(Script) programming language,
powered by the [[https://github.com/sogaiu/tree-sitter-clojure][tree-sitter-clojure]] [[https://tree-sitter.github.io/tree-sitter/][tree-sitter]] grammar.
