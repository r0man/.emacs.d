    ...
    (add-to-list 'ellama-providers
                 (cons "OpenAI o1-mini"
                       (make-llm-openai
                        ...
                        :chat-model "o1-mini"
                        :embedding-model "text-embedding-ada-002")))
    (setq ellama-provider (alist-get "OpenAI GPT-4o" ellama-providers nil nil #'string=)))
...
#+begin_src emacs-lisp
  (use-package nu-llm
    ...
    (when (fboundp 'nu-llm-make-openai)
      ...
      (add-to-list 'ellama-providers (cons "Nu OpenAI o1-mini" (nu-llm-make-openai :chat-model "o1-mini")))
...
#+begin_src emacs-lisp
  (use-package jira
    :load-path "/gnu/store/598fs53cpm095xzci19qh1irnwh0v192-emacs-jira-20250324.1926/share/emacs/site-lisp/jira-20250324.1926"
    :custom
    (jira-api-version 3)
