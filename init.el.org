...
** Cider
#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "~/workspace/cider")
  (use-package cider
    :init
    (progn
      ...
      (define-key cider-mode-map (kbd "C-c ,") 'clojure-test-run-tests)
      (define-key cider-mode-map (kbd "C-c C-,") 'clojure-test-run-tests)
