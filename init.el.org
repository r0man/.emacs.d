...
#+BEGIN_SRC emacs-lisp
  (use-package cider
    ...
    (setq cider-injected-middleware-version "0.42.1")
    (setq cider-required-middleware-version "0.42.1")
    ...
    (cider-add-to-alist 'cider-jack-in-dependencies "refactor-nrepl/refactor-nrepl" "3.9.0")
...
#+BEGIN_SRC emacs-lisp
  (use-package geiser-guile
    ...
    (add-to-list 'geiser-guile-load-path (expand-file-name "~/workspace/asahi-guix/src"))
...
#+begin_src emacs-lisp
  (use-package openai
    ...
    (when (file-exists-p "~/workspace/nu")
      ;; (setq chatgpt-model "gpt-4")
      ;; (setq codegpt-model "gpt-4")
      (setq openai-base-url "http://localhost:3005/v1")))
#+end_src
** Open With
