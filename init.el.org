...
** Inferior Hy Mode
   #+BEGIN_SRC emacs-lisp
     (add-to-list 'load-path "~/workspace/inf-hy")
     (require 'inf-hy)
     (autoload 'inf-hy "inf-hy" "Run an inferior Hy process" t)
     (autoload 'inf-hy "inf-hy-minor-mode" "Load inferior Hy minor mode" t)
